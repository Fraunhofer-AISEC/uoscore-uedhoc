...
#ifndef TYPES_MESSAGE_2_H__
#define TYPES_MESSAGE_2_H__
...
struct message_2 {
 	struct data_2 _message_2__data_2;
	cbor_string_type_t _message_2_CIPHERTEXT_2;
};


#endif /* TYPES_MESSAGE_2_H__ */
